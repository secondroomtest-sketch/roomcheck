...
const statusToneMap: Record<string, string> = {
  ...
  "pengeluaran kos": "bg-red-100 text-red-700 dark:bg-red-200 dark:text-red-900",
  "pengeluaran manajemen": "bg-rose-800 text-rose-50 dark:bg-rose-900 dark:text-rose-50",
